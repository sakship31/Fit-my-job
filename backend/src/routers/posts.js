...
app.post('/createpost',login_required,async (req,res)=>{
...
app.get('/allposts',login_required,(req,res)=>{   
...
app.get('/followingposts',login_required,(req,res)=>{
...
app.get('/single/:id',login_required,(req,res)=>{
